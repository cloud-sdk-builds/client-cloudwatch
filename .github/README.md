...
[`@aws-sdk/client-cloudwatch`](https://www.npmjs.com/package/@aws-sdk/client-cloudwatch/v/3.278.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudwatch@3.278.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5p/9wr8no9joGpaxuKxDm+Q3h6gDM7+H/JWORRFoynxRothjSMrfxXLZQhtOR2EB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudwatch": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudwatch@3.278.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudwatch@3.278.0/index.min.mjs": "sha384-5p/9wr8no9joGpaxuKxDm+Q3h6gDM7+H/JWORRFoynxRothjSMrfxXLZQhtOR2EB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudwatch/blob/refs/tags/3.278.0/LICENSE
```
